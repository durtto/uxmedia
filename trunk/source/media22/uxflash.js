...
(function(){
   ...
   var ux = Ext.ux.Media;
    ...
    ux.Flash = Ext.extend( ux, {
        ...
        * @cfg (String) externalsNamespace  Defines the namespace within the Flash class instance to hold
          ...
          If specified, the namespace is created when ExternalInterface bindings are created.
          @example
           with:   externalsNamespace : 'externals', ......
           you would reference ExternalInterface methods as:  this.externals.Play();
        */
   ...
   Ext.ux.FlashWindow = (ux.Window.Flash = Ext.extend(ux.Window, {ctype : "Ext.ux.FlashWindow", animCollapse:Ext.isIE}));
